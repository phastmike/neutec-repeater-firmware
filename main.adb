...
F:G$id_morse$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$dot_duration$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$intra_duration_char$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$intra_duration_chars$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$intra_duration_words$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$dih$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$dah$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$delay_minutes$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$delay$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$timer_init$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$timer_0$0_0$0({2}DF,SV:S),C,0,0,1,1,0
F:G$external_int_0$0_0$0({2}DF,SV:S),C,0,0,1,0,0
F:G$external_int_1$0_0$0({2}DF,SV:S),C,0,0,1,2,0
S:G$d_l$0_0$0({2}SI:S),E,0,0
S:G$dot_duration_ms$0_0$0({2}SI:U),E,0,0
S:Lmain.dot_duration$n_times$1_0$17({2}SI:U),R,0,0,[r6,r7]
S:Lmain.dot_duration$n$1_0$18({2}SI:S),R,0,0,[r4,r5]
S:Lmain.delay_minutes$n$1_0$31({2}SI:U),R,0,0,[r6,r7]
S:Lmain.delay_minutes$i$1_0$32({2}SI:S),R,0,0,[r4,r5]
S:Lmain.delay$n$1_0$35({2}SI:U),R,0,0,[r6,r7]
S:Lmain.delay$i$1_0$36({2}SI:S),R,0,0,[r4,r5]
...
S:G$timer_0$0_0$0({2}DF,SV:S),C,0,0
S:G$external_int_0$0_0$0({2}DF,SV:S),C,0,0
S:G$external_int_1$0_0$0({2}DF,SV:S),C,0,0
