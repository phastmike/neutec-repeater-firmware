M:morse
F:G$morse_init$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$morse_wpm_decrease$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$morse_wpm_increase$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$dot_duration$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$intra_duration_char$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$intra_duration_chars$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$intra_duration_words$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$dih$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$dah$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:G$dot_duration_ms$0_0$0({2}SI:U),E,0,0
S:Lmorse.dot_duration$n_times$1_0$9({2}SI:U),R,0,0,[r6,r7]
S:Lmorse.dot_duration$n$1_0$10({2}SI:S),R,0,0,[r4,r5]
...
S:G$morse_init$0_0$0({2}DF,SV:S),C,0,0
S:G$morse_wpm_decrease$0_0$0({2}DF,SV:S),C,0,0
S:G$morse_wpm_increase$0_0$0({2}DF,SV:S),C,0,0
S:G$intra_duration_char$0_0$0({2}DF,SV:S),C,0,0
S:G$intra_duration_chars$0_0$0({2}DF,SV:S),C,0,0
S:G$intra_duration_words$0_0$0({2}DF,SV:S),C,0,0
S:G$dih$0_0$0({2}DF,SV:S),C,0,0
S:G$dah$0_0$0({2}DF,SV:S),C,0,0
